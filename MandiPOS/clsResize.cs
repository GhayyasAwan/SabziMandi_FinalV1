...
public class clsResize
{
    ...
    public void _resize() //Set the resize
    {
        try
        {
            ...
            if (form.WindowState == FormWindowState.Maximized && _lastWindowState != FormWindowState.Maximized)
            {
                ...
                foreach (Control control in _controls)
                {
                    ...
                    Font _font = control.Font;
                    //Font AutoSize
                    control.Font = new System.Drawing.Font(_font.FontFamily,
