...
{
    public partial class CustomerDobatKhatay : Form
    {
        public CustomerDobatKhatay()
        {
            InitializeComponent();
        ...
        private void DgvCustomerDobat_RowDoubleClick(object sender, Janus.Windows.GridEX.RowActionEventArgs e)
        {
            ...
            {
                if (SQL.ShiftAccount(dgvCustomerDobat.RecordID(), 12, 7, true))
                {
                    Refresh();
                }
            }
        ...
        {
            bsCustomers.DataSource = DetailAccountService.GetAccountsViewList(7, true);
            bsDobatCustomers.DataSource = DetailAccountService.GetAccountsViewList(12, true);
        ...
        private void DgvCustomer_RowDoubleClick(object sender, Janus.Windows.GridEX.RowActionEventArgs e)
        {
            ...
            {
                if (SQL.ShiftAccount(dgvCustomer.RecordID(), 7, 12, false))
                {
                    Refresh();
                }
            }
